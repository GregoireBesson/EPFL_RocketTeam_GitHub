...
*/
/**************************************************************************/
pressure_temperature Adafruit_BMP280::readPressureTemperature(void) {
    int64_t var1, var2, p;

    pressure_temperature res{};
    ...
    if (var1 == 0) {
        res.pressure = 0;
        return res;  // avoid exception caused by division by zero
    }
    p = 1048576 - adc_P;
    p = (((p << 31) - var2) * 3125) / var1;
    var1 = (((int64_t) _bmp280_calib.dig_P9) * (p >> 13) * (p >> 13)) >> 25;
