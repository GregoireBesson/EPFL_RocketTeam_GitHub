...
static constexpr uint8_t XBEE_FRAME_OPTIONS[] = {
        ...
        0x00,
        0xff,
        0xff,           // dest address LSB
        0xff,           // reserved
        0xfe,           // reserved
        0x00,           // Broadcast radius (0 = max)
        0x03};          // Transmit options (disable ACK and Route discovery)

static constexpr uint8_t XBEE_FRAME_OPTIONS_CRC = 0x0e; // Needs to be adjusted if the options are changed!
