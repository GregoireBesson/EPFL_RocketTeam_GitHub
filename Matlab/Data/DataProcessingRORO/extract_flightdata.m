...
% Function run the states [pos, Q, vel, Qdot, omega, acc, angAccel] extrected from flight data
% extract the needed internal parameters. As predicted bzthe model
    global env
    ...
    for i = 2:ilast
         ...
         roro_data.P = state(i,8:10)'*roro_data.Mass;
