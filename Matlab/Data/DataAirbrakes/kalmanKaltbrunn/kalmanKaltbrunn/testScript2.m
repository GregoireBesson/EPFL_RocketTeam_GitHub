...
for i = 1:length(z)-1
    ...
    varalt = 0.0742;
    % je les mets après sinon j'ai pas de valeurs au premier tour
    R = [varalt 0 0; 0 varspeed 0; 0 0 4.0707e-04];   % baro hyper noisy
    Q = [0.001 0 0; 0 15 0; 0 0 4.e-04];     % prédicrion du thrust mauvaise
    %Q = [.000001 0 0; 0 10000 0; 0 0 1000];     % prédicrion du thrust mauvaise
%4.0707e-04
%     subplot(3,1,1)
